...
export default function CreatePaymentLinkTravel({
  ...
  const addPaymentLink = async () => {
    ...
    try {
      if (selectedBankForCreatePaymentLink === "calpay") {
        ...
        toggleShowCreatePaymentLink();
      } else if (selectedBankForCreatePaymentLink === "myghpay") {
        const res = await axios.post(
        ...
        toggleShowCreatePaymentLink();
      } else if (selectedBankForCreatePaymentLink === "theteller") {
        const res = await axios.post(
        ...
        toggleShowCreatePaymentLink();
      } else if (selectedBankForCreatePaymentLink === "hubtel") {
        const res = await axios.post(
        ...
        toggleShowCreatePaymentLink();
      } else if (selectedBankForCreatePaymentLink === "manilla") {
        const res = await axios.post(
        ...
        <div className=" w-full max-w-[500px] h-full overflow-y-scroll sm:overflow-hidden sm:h-auto bg-white rounded-md p-5 relative">
          ...
          <div className=" flex flex-col gap-2 mt-5">
            ...
            <div className="">
              ...
              >
                <option value="calpay">Cal Pay Bank</option>
                <option value="myghpay">My Gh Pay Bank</option>
