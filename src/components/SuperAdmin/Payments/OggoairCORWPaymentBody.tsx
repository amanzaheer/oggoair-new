...
import CreatePaymentLinkCORW from "./CreatePaymentLinkCORW";

export default function OggoairCORWPaymentBody() {
  ...
  const SearchTheResultCustom = async () => {
    try {
      ...
      const res = await axios.get(
        `${APILINK}/api/payment/custom?page=1&limit=10&search=${searchValue}&origin=https://oggoair.co.rw`,
        {
          headers: {
  ...
  const SearchTheResultAuto = async () => {
    try {
      ...
      setContentPerPage("10");
      const res = await axios.get(
        `${APILINK}/api/payment/auto?page=1&limit=10&search=${searchValue}&origin=https://oggoair.co.rw`,
        {
          headers: {
            Authorization: `Bearer ${SuperAdmin.accessToken}`,
          },
  ...
  const SearchTheResultWallet = async () => {
    try {
      ...
      const res = await axios.get(
        `${APILINK}/api/payment/wallet?page=1&limit=10&search=${searchValue}&origin=https://oggoair.co.rw`,
        {
          headers: {
            Authorization: `Bearer ${SuperAdmin.accessToken}`,
          },
  ...
  const getCustomPayment = async () => {
    try {
      setLoading(true);
      const res = await axios.get(
        `${APILINK}/api/payment/custom?page=${currentPage}&limit=${contentPerPage}&origin=https://oggoair.co.rw`,
        {
          headers: {
            Authorization: `Bearer ${SuperAdmin.accessToken}`,
          },
  ...
  const getAutoPayment = async () => {
    try {
      setLoading(true);
      const res = await axios.get(
        `${APILINK}/api/payment/auto?page=${currentPage}&limit=${contentPerPage}&origin=https://oggoair.co.rw`,
        {
          headers: {
            Authorization: `Bearer ${SuperAdmin.accessToken}`,
          },
  ...
  const getWalletPayment = async () => {
    try {
      setLoading(true);
      const res = await axios.get(
        `${APILINK}/api/payment/wallet?page=${currentPage}&limit=${contentPerPage}&origin=https://oggoair.co.rw`,
        {
          headers: {
            Authorization: `Bearer ${SuperAdmin.accessToken}`,
          },
