...
export default function ExtraSearvicesHeroSection() {
  return (
    <div className=" w-full bg-[#00B3FF14] pb-10 p-5 sm:p-10 rounded-xl">
      <div className=" w-full flex items-center flex-wrap sm:justify-between ">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="  mt-1 text-sm sm:textbase">Search</p>
        </div>
        ...
        <div className="flex flex-col items-center translate-y-3">
          ...
          <p className=" text-sm sm:textbase">
        ...
        <div className=" translate-y-3 flex flex-col items-center">
          ...
          <p className="text-center mt-1 text-sm sm:textbase">
