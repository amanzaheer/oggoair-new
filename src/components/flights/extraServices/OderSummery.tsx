...
export default function OrderSummery({
  ...
  const [extraSearvicesCharge, setExtraSearvicesCharge] = useState(0);
  ...
  useEffect(() => {
    let total =
      parseFloat(bookingDetails.bookingDetails.total_amount) +
      parseFloat(bookingDetails.payment.comissionAmount);

    for (let i of selectedServices) {
      total = total + parseFloat(i.charge);
    }
    setTotalPay(total);
    ...
    <div className="">
      ...
      {/* <div className=" w-full rounded-xl p-5 bg-[#F8F9FE] relative mt-5">
        <div className=" font-medium flex items-center justify-between">
          ...
          <p className="">$ {bookingDetails.bookingDetails.total_amount}</p>
        </div>
        ...
        <div className=" flex items-center justify-between mt-5">
          ...
          <p className="  font-medium text-2xl ">$ {totalPay}</p>
        </div>
      </div> */}
