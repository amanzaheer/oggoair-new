...
function SingleStopSelectItem({
  ...
  const changeValue = (value: any) => {
    ...
    if (filterTypes.stopSelectedType.includes(value)) {
      const newStops = [...filterTypes.stopSelectedType].filter(
        (stop) => stop !== value
      );
      changeFilterTypesValue("stopSelectedType", newStops);
    } else {
      const newStops = [...filterTypes.stopSelectedType, value];
      changeFilterTypesValue("stopSelectedType", newStops);
    }
  };
...
export default SingleStopSelectItem;
