...
function SingleTicketExchangeSelectItem({
  title,
  filterTypes,
  ...
  const changeValue = (value: any) => {
    ...
    if (filterTypes.ticketExchange.includes(value)) {
      const newStops = [...filterTypes.ticketExchange].filter(
        (stop) => stop !== value
      );
      changeFilterTypesValue("ticketExchange", newStops);
    } else {
      const newStops = [...filterTypes.ticketExchange, value];
      changeFilterTypesValue("ticketExchange", newStops);
    }
  };
...
export default SingleTicketExchangeSelectItem;
